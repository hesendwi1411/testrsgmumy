...
class Mst_user extends MX_Controller {
	...
	public function __construct()
	{
		...
		$this->load->model(array('m_mst_user','ref/m_ref'));
	}

	public function index()
	{
		$header = array('company' => 'Company', 'title' => 'Data Pengguna');
		$data 	= array(
			'data' => $this->m_mst_user->get_data()
		);
	...
	public function add()
	{
		$header = array('company' => 'Company', 'title' => 'Tambah Pengguna');
		$data 	= array(
			'title_breadcrumb' 	=> 'Tambah',
			'title_header' 		=> 'Tambah Pengguna',
			'url_refresh'		=> base_url('mst_user/add'),
			'url_action'		=> base_url('mst_user/do_add'),
